...
public final class GameTimeTaskManager implements Runnable
{
	...
	protected GameTimeTaskManager()
	{
		...
		// Zaken door is closed at this moment.
		_closed = true;
	...
	private void initZakenDoor()
	{
		if (getGameTime() < 12 && _closed)
		{
			...
			ThreadPool.schedule(() ->
			{
				...
				_closed = !_closed;
			}, (60 - getGameTime()) * MILLISECONDS_PER_GAME_MINUTE);
		}
	}
