...
public class HeavyMedal extends Quest
{
	...
	public HeavyMedal()
	{
		...
		for(int[] _spawn : _spawns_roy)
			addSpawn(CAT_ROY, _spawn[0], _spawn[1], _spawn[2], _spawn[3], false, 0, false);
		for(int[] _spawn : _spawns_winnie)
			addSpawn(CAT_WINNIE, _spawn[0], _spawn[1], _spawn[2], _spawn[3], false, 0, false);
		addKillId();
	}
	...
	public String onKill(Npc npc, Player player, boolean isPet)
	{
		...
		st.dropItems(MEDAL, 1, 0, 500000);		
		st.dropItems(GLITTERING_MEDAL, 1, 0, 100000);
