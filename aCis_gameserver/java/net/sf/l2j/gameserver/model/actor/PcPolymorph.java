...
{
       private CharSelectInfo _polymorphInfo;
       ...
       public CharSelectInfo getPolymorphInfo()
       {
               return _polymorphInfo;
       }
      
       public void setPolymorphInfo(CharSelectInfo polymorphInfo)
       {
               _polymorphInfo = polymorphInfo;
              
               for (Object object : getKnownList().getKnownObjects())
               {
