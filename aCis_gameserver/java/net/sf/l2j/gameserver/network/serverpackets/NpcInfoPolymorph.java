...
public final class NpcInfoPolymorph extends L2GameServerPacket
{
       ...
       private final CharSelectInfo _morph;
       ...
       public NpcInfoPolymorph(PcPolymorph cha)
       {
               ...
               _template = CharTemplates.getTemplate(_morph.BaseClassId());
               _clan = ClanTable.getInstance().getClan(_morph.setClanId());
       ...
       protected final void writeImpl()
       {
			CharSelectSlot slot = _morph[i];
               ...
               writeD(_morph.getPaperdollObjectId(Inventory.PAPERDOLL_HAIRALL));
               ...
               writeD(0x00);
		getClient().getCharSelectSlot(_morph);
       }
}
